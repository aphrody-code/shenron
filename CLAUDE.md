...
bun apps/bot/scripts/ingest-databooks-rag.ts         # PG -> data/rag/corpus-databooks.json (à relancer après un dépôt de transcriptions)
bun --filter @shenron/bot run rag:build              # rebuild complet rag_chunks + vec_chunks (~2 h, ~60 927 chunks)
