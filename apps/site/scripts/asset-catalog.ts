...
export const SFX_CATALOG: readonly SfxCatalogEntry[] = [
	...
	{ filename: "kamehameha.mp3", url: `${MI}/kamehameha.mp3`, role: "kamehameha", source: "myinstants" },
	{
	...
	{ filename: "charging.mp3", url: `${MI}/charging.mp3`, role: "kiCharge-src", source: "myinstants" },
	...
	{ filename: "final-flash.mp3", url: `${MI}/final-flash.mp3`, role: "finalFlash", source: "myinstants" },
	{ filename: "over9000.mp3", url: `${MI}/over-9000.mp3`, role: "over9000", source: "myinstants" },
	{ filename: "its-over-9000.mp3", url: `${MI}/its-over-9000.mp3`, role: "over9000-alt", source: "myinstants" },
	...
	{ filename: "explosion.mp3", url: `${MI}/explosion.mp3`, role: "extra-explosion", source: "myinstants" },
	{ filename: "dragon-ball.mp3", url: `${MI}/dragon-ball.mp3`, role: "extra-dragon-ball", source: "myinstants" },
	...
	{ filename: "kienzan.mp3", url: `${MI}/kienzan.mp3`, role: "extra-kienzan", source: "myinstants" },
	{ filename: "kaioken.mp3", url: `${MI}/kaioken.mp3`, role: "extra-kaioken", source: "myinstants" },
	{ filename: "kaio-ken.mp3", url: `${MI}/kaio-ken.mp3`, role: "extra-kaioken-alt", source: "myinstants" },
	{ filename: "fusion.mp3", url: `${MI}/fusion.mp3`, role: "extra-fusion", source: "myinstants" },
	{ filename: "shenron.mp3", url: `${MI}/shenron.mp3`, role: "extra-shenron", source: "myinstants" },
	...
	{ filename: "spirit-bomb.mp3", url: `${MI}/spirit-bomb.mp3`, role: "extra-spirit-bomb", source: "myinstants" },
	{ filename: "nimbus.mp3", url: `${MI}/nimbus.mp3`, role: "nimbus", source: "myinstants" },
	{ filename: "tapion-ocarina.mp3", url: `${MI}/tapion-ocarina.mp3`, role: "tapion", source: "myinstants" },
	{
