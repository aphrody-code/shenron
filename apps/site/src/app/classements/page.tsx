...
export default async function ClassementsPage() {
	...
	return (
		<div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
			<PageHeader
				title="CLASSEMENTS"
				subtitle="Les Top 3 de la communauté — notes 1 à 5 ★"
			/>
			...
			<div className="mt-14 rounded-2xl border border-dbz-orange/25 bg-dbz-orange/5 p-6 text-center">
				...
				<p className="mx-auto mt-2 max-w-lg text-sm text-white/60">
					Connecte-toi avec Discord, ouvre une fiche épisode / film / jeu, et
					laisse ta note. Ton vote peut faire basculer le podium.
				</p>
