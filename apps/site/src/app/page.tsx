...
import { HomeMediaCatalog } from "@/components/home/HomeMediaCatalog";
import { HomeMenuJourney } from "@/components/home/HomeMenuJourney";
...
export default async function Home() {
	...
	return (
		<>
			...
			/>
			{catalog && access && (
				<HomeMediaCatalog catalog={catalog} access={access} config={config.catalogue} />
			)}
			{access && <HomeMenuJourney access={access} config={config.journey} />}
		</>
	);
}
