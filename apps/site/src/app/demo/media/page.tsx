...
import {
	BackgroundImage,
	HeroBackground,
} from "@/components/media/BackgroundImage";
			...
			<div className="mx-auto max-w-[1100px] space-y-20 px-6 py-16">
				...
				<section className="reveal-up space-y-4">
					...
					<p className="text-white/70">
						Vidéo <code>autoplay muted loop playsinline</code> jouée seulement
						quand visible (IntersectionObserver), poster avant lecture, bouton
						play/pause accessible, neutralisée si{" "}
				...
				<section className="reveal-up space-y-4">
					<h2 className="font-display text-2xl font-bold">
						Encodage frames → GIF (modern-gif)
					</h2>
					<p className="text-white/70">
						Génère N frames procéduraux dans un canvas puis les encode en GIF
						animé via <code>encodeFramesToGif</code> (worker inline).
					</p>
					<GifEncoderDemo />
				</section>
			</div>
