		...
		<div className="space-y-4">
			<div className="card">
				...
				<p className="mt-1 text-sm text-zinc-400">
					Avertissements actifs, jails en cours, dernières actions des
					modérateurs. Toutes les opérations sont auditées dans{" "}
					<code>action_logs</code>.
				</p>
			</div>
							...
							<div className="flex items-center justify-between">
								...
								<button
									...
									onClick={() => {
										if (
											confirm(
												`Purger les ${list.length} warn(s) de ${userId} ?`,
											)
										)
											onClearAll(userId);
									}}
						...
						return (
							...
							>
								<div>
									...
									{!j.expiresAt && (
										<div className="text-zinc-500">Indéfini</div>
									)}
