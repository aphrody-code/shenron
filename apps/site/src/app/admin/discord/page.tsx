		...
		<div className="w-full max-w-6xl mx-auto space-y-10">
			...
			{channels.length === 0 && roles.length === 0 && (
				<div className="dbz-panel p-6 text-center text-white/50">
					<p className="text-lg font-saiyan text-dbz-orange mb-2">
			...
			<section>
				<h2 className="text-2xl font-saiyan text-dbz-yellow uppercase mb-1">
					Salons
				</h2>
				<p className="text-xs text-white/40 mb-4">
					Les salons sont regroupés par type. Chaque salon affiche son nom et
					son identifiant interne Discord.
				</p>
				{channels.length === 0 ? (
					<div className="dbz-panel p-6 text-center text-white/50">
			...
			<section>
				...
				<p className="text-xs text-white/40 mb-4">
					...
					&laquo;&nbsp;gérés&nbsp;&raquo; appartiennent à un bot ou une
					intégration.
				</p>
				{roles.length === 0 ? (
					<div className="dbz-panel p-6 text-center text-white/50">
						Aucun rôle accessible.
					</div>
				) : (
