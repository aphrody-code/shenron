	...
	return (
		<div className="w-full max-w-6xl mx-auto">
			<div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
				...
				<Link href="/admin/posts/new" className="dbz-button !text-lg">
					NOUVEL ARTICLE
				</Link>
			</div>
					...
					<tbody className="divide-y-2 divide-dbz-border">
						{posts.map((post: any) => (
							...
							>
								...
								<td className="p-4">
									<span
										className={`px-2 py-1 border-2 text-[10px] font-bold uppercase ${post.published ? "bg-green-500/20 text-green-500 border-green-500/50" : "bg-dbz-yellow/20 text-dbz-yellow border-dbz-yellow/50"}`}
									>
								...
								<td className="p-4">
									<Link
										...
										className="font-saiyan text-xl text-dbz-blue-light hover:text-dbz-yellow transition-colors uppercase tracking-wider"
									>
										MODIFIER
									</Link>
								</td>
