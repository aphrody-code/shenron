...
!(function (n, e, t) {
	"use strict";
	e.behaviors.bneAgeGate = {
		attach: (e) => {
			n(t("bneAgeGate", "#js-age-gate-modal", e)).each(function () {
				const e = n(this),
					t = document.getElementById("js-age-gate-modal__yes"),
					a = document.getElementById("js-age-gate-modal__no");
				(localStorage.getItem("age_gate") < e.data("age-gate") && e.show(),
					t.addEventListener("click", function () {
						(e.find("button").attr("disabled", "disabled"),
							localStorage.setItem("age_gate", e.data("age-gate")),
							e.hide());
					}),
					a.addEventListener("click", function () {
						(e.find("button").attr("disabled", "disabled"), (window.location.href = "/"));
					}));
			});
		},
	};
