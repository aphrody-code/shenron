...
import { Bot, ButtonComponent, Discord, Guard, Slash, SlashChoice, SlashOption } from "@rpbey/discordy";
...
export class BingoCommand {
  ...
  async bingo(
    ...
    const defaultStake = await this.settings.getInt("zeni.game.loss_penalty", ZENI_GAME_LOSS_PENALTY);
