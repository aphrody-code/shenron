...
const ARCS = [
    ...
    { sagaSlug: "champa", slug: "u6-tournament", name: "Tournoi Univers 6 vs Univers 7", orderIdx: 1 },
    { sagaSlug: "future-trunks", slug: "goku-black", name: "Goku Black", orderIdx: 1 },
    { sagaSlug: "tournament-of-power", slug: "top-recruitment", name: "Recrutement pour le Tournoi", orderIdx: 1 },
