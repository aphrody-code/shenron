 ...
 * -------------------------------------------------------------------------------------------------------
 */
import { SlashCommandBuilder, SlashCommandStringOption, type CommandInteraction } from "discord.js";
import { Discord, Slash, SlashOption } from "@rpbey/discordy";

const cmd = new SlashCommandBuilder().setName("planet").setDescription("Select a planet");
