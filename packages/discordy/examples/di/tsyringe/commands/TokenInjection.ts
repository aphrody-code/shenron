 ...
 * -------------------------------------------------------------------------------------------------------
 */
import { TsyringeDependencyRegistryEngine, tsyringeDependencyRegistryEngine } from "@rpbey/di";
import type { CommandInteraction } from "discord.js";
import { Discord, DIService, Slash } from "@rpbey/discordy";
...
export class ExampleToken {
	...
	async tsyringe(interaction: CommandInteraction): Promise<void> {
		if (DIService.engine === tsyringeDependencyRegistryEngine) {
			const allDiscordClasses = container.resolveAll(TsyringeDependencyRegistryEngine.token);
