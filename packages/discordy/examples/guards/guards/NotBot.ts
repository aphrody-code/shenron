...
import { type ArgsOf, type GuardFunction, SimpleCommandMessage } from "@rpbey/discordy";
...
export const NotBot: GuardFunction<
	| ArgsOf<Events.MessageCreate | Events.MessageReactionAdd | Events.VoiceStateUpdate>
	| ButtonInteraction
	| ChannelSelectMenuInteraction
	| CommandInteraction
	| ContextMenuCommandInteraction
