...
describe("Choice", () => {
	...
	it("Should execute the enum choice interaction", async () => {
		const interaction = new FakeInteraction({
			commandName: "hello",
			options: [new FakeOption("choice", ApplicationCommandOptionType.String, "hello")],
	...
	it("Should execute the string choice interaction", async () => {
		const interaction = new FakeInteraction({
			commandName: "string",
			options: [new FakeOption("choice", ApplicationCommandOptionType.String, "B")],
			type: InteractionType.Command,
		});
	...
	it("Should execute the number choice interaction", async () => {
		const interaction = new FakeInteraction({
			commandName: "number",
			options: [new FakeOption("choice", ApplicationCommandOptionType.Number, 3)],
			type: InteractionType.Command,
		});
