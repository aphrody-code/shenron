...
__reExport(index_exports, require("@rpbey/di"), module.exports);
__reExport(index_exports, require("@rpbey/internal"), module.exports);

// src/Client.ts
var import_discord = require("discord.js");
var Client = class _Client extends import_discord.Client {
  // Core properties
  _botId;
  _isBuilt = false;
  _prefix;
...
var import_internal = require("@rpbey/internal");
...
var DApplicationCommand = class _DApplicationCommand extends Method {
  ...
  toSubCommand() {
    const option = DApplicationCommandOption.create({
      ...
      type: import_discord3.ApplicationCommandOptionType.Subcommand
  ...
  toJSON() {
    const options = [...this.options].reverse().sort((a, b) => {
      if ((a.type === import_discord3.ApplicationCommandOptionType.Subcommand || a.type === import_discord3.ApplicationCommandOptionType.SubcommandGroup) && (b.type === import_discord3.ApplicationCommandOptionType.Subcommand || b.type === import_discord3.ApplicationCommandOptionType.SubcommandGroup)) {
...
var import_internal2 = require("@rpbey/internal");
...
var import_internal3 = require("@rpbey/internal");
...
var DApplicationCommandOption = class _DApplicationCommandOption extends import_internal3.Decorator {
  ...
  get isNode() {
    return this.type === import_discord4.ApplicationCommandOptionType.Subcommand || this.type === import_discord4.ApplicationCommandOptionType.SubcommandGroup;
  }
  get maxValue() {
  ...
  parseType(interaction) {
    switch (this.type) {
      case import_discord4.ApplicationCommandOptionType.Attachment:
        return interaction.options.getAttachment(this.name) ?? void 0;
      case import_discord4.ApplicationCommandOptionType.String:
        return interaction.options.getString(this.name) ?? void 0;
      case import_discord4.ApplicationCommandOptionType.Boolean:
        return interaction.options.getBoolean(this.name) ?? void 0;
      case import_discord4.ApplicationCommandOptionType.Number:
        return interaction.options.getNumber(this.name) ?? void 0;
      case import_discord4.ApplicationCommandOptionType.Integer:
        return interaction.options.getInteger(this.name) ?? void 0;
      case import_discord4.ApplicationCommandOptionType.Role:
        return interaction.options.getRole(this.name) ?? void 0;
      case import_discord4.ApplicationCommandOptionType.Channel:
        return interaction.options.getChannel(this.name) ?? void 0;
      case import_discord4.ApplicationCommandOptionType.Mentionable:
        return interaction.options.getMentionable(this.name) ?? void 0;
      case import_discord4.ApplicationCommandOptionType.User:
...
var import_internal4 = require("@rpbey/internal");
...
var import_di = require("@rpbey/di");
var import_internal5 = require("@rpbey/internal");
var DDiscord = class _DDiscord extends import_internal5.Decorator {
  ...
  get instance() {
    return import_di.DIService.engine.getService(this.from);
  }
  get modal() {
...
var import_internal6 = require("@rpbey/internal");
var DGuard = class _DGuard extends import_internal6.Decorator {
  _fn;
  get fn() {
    return this._fn;
  }
    ...
    return Promise.all(
      this.options.sort((a, b) => (a.index ?? 0) - (b.index ?? 0)).map(async (op, index) => {
        ...
        if (op.type === 3 /* User */) {
          ...
          if (command.message.channel.type === import_discord5.ChannelType.DM) {
...
var import_internal7 = require("@rpbey/internal");
var DSimpleCommandOption = class _DSimpleCommandOption extends import_internal7.Decorator {
  _name;
  _description;
  _type;
  get name() {
...
var import_internal8 = require("@rpbey/internal");
function Bot(...botIds) {
  return (target, key, descriptor) => {
    MetadataStorage.instance.addModifier(
      import_internal8.Modifier.create(
        (original) => {
          original.botIds = [
            ...original.botIds,
...
function ContextMenu(options) {
  return (target, key) => {
    ...
    if (options.type === import_discord6.ApplicationCommandType.Message) {
...
var import_internal9 = require("@rpbey/internal");
function Guard(...fns) {
  return (target, key, descriptor) => {
...
var import_internal10 = require("@rpbey/internal");
function Guild(...guildIds) {
  return (target, key, descriptor) => {
    MetadataStorage.instance.addModifier(
      import_internal10.Modifier.create(
        (original) => {
...
var import_internal11 = require("@rpbey/internal");
  ...
  return (target, key) => {
    ...
    if (options instanceof import_discord7.SlashCommandBuilder) {
      ...
      applicationCommand = DApplicationCommand.create({
        ...
        nsfw: options.nsfw,
        type: import_discord7.ApplicationCommandType.ChatInput
      });
    } else {
      applicationCommand = DApplicationCommand.create({
        botIds: options.botIds,
...
var import_internal12 = require("@rpbey/internal");
function SlashChoice(...choices) {
  return (target, key, index) => {
    MetadataStorage.instance.addModifier(
      import_internal12.Modifier.create((original) => {
...
var import_internal13 = require("@rpbey/internal");
function SlashGroup(options, root) {
  return (target, key, descriptor) => {
    if (typeof options === "string") {
      MetadataStorage.instance.addModifier(
        import_internal13.Modifier.create(
          (original) => {
            if (original instanceof DDiscord) {
...
var import_internal14 = require("@rpbey/internal");
var import_discord8 = require("discord.js");
function SlashOption(options, transformer) {
  return (target, key, index) => {
    SlashNameValidator(options.name);
    let option;
    if (options instanceof import_discord8.SlashCommandAttachmentOption || options instanceof import_discord8.SlashCommandBooleanOption || options instanceof import_discord8.SlashCommandRoleOption || options instanceof import_discord8.SlashCommandMentionableOption || options instanceof import_discord8.SlashCommandUserOption) {
    ...
    } else if (options instanceof import_discord8.SlashCommandChannelOption) {
      option = DApplicationCommandOption.create({
    ...
    } else if (options instanceof import_discord8.SlashCommandIntegerOption || options instanceof import_discord8.SlashCommandNumberOption) {
    ...
    } else if (options instanceof import_discord8.SlashCommandStringOption) {
      const choices = options.choices?.map(
        (choice) => DApplicationCommandOptionChoice.create(choice)
      );
      option = DApplicationCommandOption.create({
...
var ApplicationCommandManager = class {
  ...
  async initGlobalApplicationCommands(retainDeleted) {
    ...
    const discordCommands = allDiscordCommands.filter(
      (cmd) => !cmd.guild && cmd.type !== import_discord9.ApplicationCommandType.PrimaryEntryPoint
    );
...
var DebugManager = class {
  ...
  printOptions(options, depth) {
    ...
    options.forEach((option, optionIndex) => {
      ...
      this.client.logger.log(
        `${(option.type === import_discord10.ApplicationCommandOptionType.Subcommand || option.type === import_discord10.ApplicationCommandOptionType.SubcommandGroup) && optionIndex !== 0 ? "\n" : ""}${tab}>> ${option.name}: ${import_discord10.ApplicationCommandOptionType[option.type].toLowerCase()} (${className}.${key})`
      );
...
var import_di2 = require("@rpbey/di");
...
var InteractionHandler = class {
  ...
  executeInteraction(interaction) {
    ...
    if (interaction.type === import_discord11.InteractionType.ModalSubmit) {
  ...
  getApplicationCommandGroupTree(interaction) {
    ...
    const getOptionsTree = (option) => {
      ...
      if (!option.type || option.type === import_discord11.ApplicationCommandOptionType.SubcommandGroup || option.type === import_discord11.ApplicationCommandOptionType.Subcommand) {
        if (option.name) {
  ...
  getApplicationCommandFromTree(tree) {
    return this.client.applicationCommandSlashesFlat.find((slash) => {
      switch (tree.length) {
        case 1:
          return slash.group === void 0 && slash.subgroup === void 0 && slash.name === tree[0] && slash.type === import_discord11.ApplicationCommandType.ChatInput;
        case 2:
          return slash.group === tree[0] && slash.subgroup === void 0 && slash.name === tree[1] && slash.type === import_discord11.ApplicationCommandType.ChatInput;
        case 3:
          return slash.group === tree[0] && slash.subgroup === tree[1] && slash.name === tree[2] && slash.type === import_discord11.ApplicationCommandType.ChatInput;
        default:
          return false;
      }
    });
...
var import_di3 = require("@rpbey/di");
var import_internal15 = require("@rpbey/internal");
...
var MetadataStorage = class _MetadataStorage {
  ...
  addDiscord(discord) {
    ...
    import_di3.DIService.engine.addService(discord.classRef);
  }
  addGuard(guard) {
    this._guards.push(guard);
    import_di3.DIService.engine.addService(guard.classRef);
  }
...
`
    ...
    await import_internal15.Modifier.modify(this._modifiers, this._simpleCommandOptions);
    await import_internal15.Modifier.modify(this._modifiers, this._buttonComponents);
    await import_internal15.Modifier.modify(this._modifiers, this._modalComponents);
    await import_internal15.Modifier.modify(this._modifiers, this._reactions);
    await import_internal15.Modifier.modify(this._modifiers, this._selectMenuComponents);
  ...
  groupSlashes() {
    ...
    this._applicationCommandSlashGroups.forEach((group) => {
      ...
      const slashParent = DApplicationCommand.create({
        ...
        type: import_discord12.ApplicationCommandType.ChatInput
    ...
    this._applicationCommandSlashSubGroups.forEach((subGroup) => {
      ...
      const option = DApplicationCommandOption.create({
        ...
        required: true,
        type: import_discord12.ApplicationCommandOptionType.SubcommandGroup
