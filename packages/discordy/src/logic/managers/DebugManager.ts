...
export class DebugManager {
	...
	private printComponentType(name: string, components: readonly DComponent[]): void {
	...
	private printOptions(options: DApplicationCommandOption[], depth: number): void {
	...
	private printSimpleOptions(options: DSimpleCommandOption[], depth: number): void {
		const tab = Array(depth).join("\t\t");
