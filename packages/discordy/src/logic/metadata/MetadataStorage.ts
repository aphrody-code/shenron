...
export class MetadataStorage {
	...
	// groups
	private _applicationCommandSlashGroups: DApplicationCommandGroup<Partial<DApplicationCommand>>[] =
		[];
	...
	async build(): Promise<void> {
		...
		await Modifier.modify(this._modifiers, this._applicationCommandSlashOptions);
