...
export type DecoratorConstructor<T extends Decorator> = new (...args: any[]) => T;
...
export class Modifier<TTarget extends Decorator = Decorator> extends Decorator {
	...
	static create<TModificationTarget extends Decorator>(
		...
		return new Modifier<TModificationTarget>(modificationFunction, applicableDecoratorTypes);
	}
