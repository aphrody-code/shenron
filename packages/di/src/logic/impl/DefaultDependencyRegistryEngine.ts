...
export class DefaultDependencyRegistryEngine implements IDependencyRegistryEngine {
	...
	public static get instance(): DefaultDependencyRegistryEngine {
		DefaultDependencyRegistryEngine._instance ??= new DefaultDependencyRegistryEngine();
