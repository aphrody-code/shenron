...
export const jails = sqliteTable(
	...
	(t) => [
		index("idx_jails_user").on(t.userId),
		index("idx_jails_expires").on(t.expiresAt),
	],
);
...
export const tickets = sqliteTable(
	...
	(t) => [
		index("idx_tickets_owner").on(t.ownerId),
		index("idx_tickets_closed").on(t.closed),
	],
);
...
export const giveaways = sqliteTable(
	...
	(t) => [
		index("idx_giveaway_ends").on(t.endsAt),
		index("idx_giveaway_ended").on(t.ended),
	],
);
...
export const dbCharacters = sqliteTable(
	...
	(t) => [
		index("idx_db_char_race").on(t.race),
		index("idx_db_char_affiliation").on(t.affiliation),
	],
);
